...
class kit_model_atributos{	
    var $kit_id='';
    var $name='';
    var $type_kit='';
    var $pay_direct='';
    var $pay_binary='';
    var $pay_created_binary='';
    var $pay_residul_uni='';
    var $pay_residul_com='';
    var $pay_goals='';
    var $status_value='';
...
class Kit_Model extends CI_Model{ 
    ...
    public function __construct() {
        parent::__construct();  
        $this->table = 'kit';
	$this->table_id = 'kit_id';
        $this->kit_id ='';
        $this->name='';
        $this->type_kit='';
        $this->pay_direct='';
        $this->pay_binary='';
        $this->pay_created_binary='';
        $this->pay_residul_uni='';
        $this->pay_residul_com='';
        $this->pay_goals='';
	$this->status_value='';
	$this->created_at='';
	$this->created_by='';
	...
	$this->fields = new kit_model_atributos();
    }   
