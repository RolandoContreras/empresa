...
class Order_commissions_Model extends CI_Model{ 

    public function __construct() {
        parent::__construct();  
        $this->table = 'order_commissions';
	$this->table_id = 'order_commissions_id';
        $this->order_commissions_id='';
	$this->order_id='';
        $this->commissions_id='';
	$this->status_value='';
	$this->created_at='';
	...
	$this->updated_at='';
	$this->updated_by='';
	$this->fields = new order_commissions_model_atributos();
    }   
