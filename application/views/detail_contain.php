...
<div class="product">
    <div class="images">
    <!---------Principal Image----------->    
    <a href="<?php echo SERVER2.$obj_products->custom_image."?999";?>" class="zoom">
        <img src="<?php echo SERVER2.$obj_products->custom_image."?999";?>" class="attachment-shop_single wp-post-image" alt="<?php echo convert_slug($obj_products->name);?>"/>
    </a>
    <!---------Show Thumbnails---------->
        <div class="thumbnails">
            <a href="<?php echo SERVER2.$obj_products->big_image;?>" class="zoom first" data-rel="prettyPhoto[product-gallery]">
                <img width="90" height="90" src="<?php echo SERVER2.$obj_products->big_image."?999";?>" class="attachment-shop_thumbnail" alt="<?php echo convert_slug($obj_products->name);?>"/>
            </a>
            <a href="<?php echo SERVER2.$obj_products->medium_image;?>" class="zoom" data-rel="prettyPhoto[product-gallery]">
                <img width="90" height="90" src="<?php echo SERVER2.$obj_products->medium_image."?999";?>" class="attachment-shop_thumbnail" alt="<?php echo convert_slug($obj_products->name);?>"/>
            </a>
            <a href="<?php echo SERVER2.$obj_products->small_image;?>" class="zoom last" data-rel="prettyPhoto[product-gallery]">
                <img width="90" height="90" src="<?php echo SERVER2.$obj_products->small_image."?999";?>" class="attachment-shop_thumbnail" alt="<?php echo convert_slug($obj_products->name);?>"/>
            </a>
        </div>
    <!---------------------------------->
    </div>
                    ...
                    <?php foreach ($comments as $value) { ?>
                            <li class="comment even thread-even depth-1">
                                <div class="comment_container">
                                    <img alt='<?php echo $value->name;?>' src='<?php echo site_url().'static/images/person.png?999';?>' class='avatar avatar-60 photo' height='60' width='60'/>
                         ...
                         <p class="number_text">Comisión</p>
                                    ...
                                    <span>
                                        ...
                                        <a href="<?php echo site_url().convert_slug($value->category."/".$value->name);?>">
                                                <img class="image_products" src="<?php echo SERVER2.$value->big_image."?999";?>" class="attachment-shop_catalog" alt="<?php echo $value->name;?>"/>
...
<script type='text/javascript' src='<?php echo site_url().'static/backoffice/js/superfish.js?999';?>'></script>  
