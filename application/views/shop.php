            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="span9 right" id="content">
                        ...
                        <ul class="products">
                            ...
                            <li class="product">
                                ...
                                <p class="number_price">
                                    <?php echo format_number($obj_products->pay_sale);?></p> <span> <img class="image_oferta" src="<?php echo site_url().'static/images/oferta.png?999';?>"/> </span> <a href="<?php echo site_url().convert_slug($obj_products->category." / ".$obj_products->name);?>"> <img class="image_products" width="300" height="300" src="<?php echo SERVER2.$obj_products->big_image."?999";?>" alt="<?php echo convert_slug($obj_products->name);?>"/> <h3><?php echo corta_texto($obj_products->name,22);?> </h3> </a>
                                <div class="short_desc">
                                    <?php echo corta_texto($obj_products->sumilla,60);?></div> <span class="price">
                                        <ins>
                                            <?php 
                                                if(!is_null($obj_products->price_del)){ ?>
                                                    <del>
                                                        <span class="amount">S/.<?php echo $obj_products->price_del;?></span>
                                                    </del>
                                                <?php } ?>
                                            <span class="amount">S/.<?php echo $obj_products->price;?></span>
                                        </ins>
                                </span>
                                <br/>
                        ...
                        $price=$ruta[1]; if($price!="porprecio" ){ ?>
                        <nav class="woocommerce-pagination">
                            <div class="subnav nobg">
                                <div class="span8">
                                    <div class="pagination" style="margin-left: 50%">
                                        <?php echo $obj_pagination; ?> </div>
                                </div>
                            </div>
                        </nav>
                        <?php } ?>
