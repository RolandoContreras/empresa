<nav class="nav nav__primary clearfix">
    <ul id="topnav" class="sf-menu"><li id="menu-item-1998" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-203 current_page_item"><a href="<?php echo site_url().'home';?>">Home</a></li>
                ...
                <li id="menu-item-2014" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children"><a href="<?php echo site_url().'compras';?>">Compras</a>
                <ul class="sub-menu">
                    ...
                    <li id="menu-item-2015" class="menu-item menu-item-type-taxonomy menu-item-object-product_cat"><a href="">Donec vitae</a>
                    ...
                    <li id="menu-item-2019" class="menu-item menu-item-type-taxonomy menu-item-object-product_cat"><a href="">Ut eget tortor</a>
                    ...
                    <li id="menu-item-2016" class="menu-item menu-item-type-taxonomy menu-item-object-product_cat"><a href="">Nam felis nulla</a>
                    ...
                    <li id="menu-item-2017" class="menu-item menu-item-type-taxonomy menu-item-object-product_cat"><a href="">Proin ut</a>
                        <ul class="sub-menu">
                        <li id="menu-item-2013" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="">Category 1</a></li>
                        <li id="menu-item-2012" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="">Category 2</a></li>
                        <li id="menu-item-2011" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="">Category 3</a></li>
