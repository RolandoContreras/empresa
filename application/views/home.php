...
<body class="home page page-id-203 page-template page-template-page-home-php has_woocommerce has_shop">
    ...
    <div id="parallax-slider-5406108c1acd1" class="parallax-slider"><ul class="baseList"><li data-preview="http://livedemo00.template-help.com/woocommerce_51107/wp-content/uploads/2011/07/slide01.jpg" data-img-width="1920" data-img-height="700"><div class="slider_caption>"><h2><span>Top Products</span></h2>
    <h3>
    <p>
    <span>Lorem ipsum dolor sit amet, consectetur. </span>
    </p>
    <a href="blog/">Show Now!</a>
    </h3></div></li><li data-preview="http://livedemo00.template-help.com/woocommerce_51107/wp-content/uploads/2011/07/slide02.jpg" data-img-width="1920" data-img-height="700"><div class="slider_caption>"><h2><span>Top Products</span></h2>
    <h3>
    <p>
    <span>Lorem ipsum dolor sit amet, consectetur. </span>
    </p>
    ...
    </div></li><li data-preview="http://livedemo00.template-help.com/woocommerce_51107/wp-content/uploads/2011/07/slide03.jpg" data-img-width="1920" data-img-height="700"><div class="slider_caption>"><h2><span>Top Products</span></h2>
    <h3>
    <p>
    <span>Lorem ipsum dolor sit amet, consectetur. </span>
    </p>
    ...
    <div class="custom_banners"><div class="custom_banners_wrap_inner">
    <div class="row ">
    <div class="span4 "><a href="product/product-12/" title="Meat Grinder -20%" class="banner-wrap "><figure class="featured-thumbnail"><img src="http://livedemo00.template-help.com/woocommerce_51107/wp-content/uploads/2014/08/banner01.jpg" title="Meat Grinder -20%" alt=""/></figure><div class="extra-wrap"><h5>Meat Grinder -20%</h5><p><span>Nunc pulvinar turpis</span></p><div class="link-align banner-btn">Shop now</div></div></a> </div>
    <div class="span4 "><a href="product/product-9/" title=" Vacuum Cleaner -10%" class="banner-wrap "><figure class="featured-thumbnail"><img src="http://livedemo00.template-help.com/woocommerce_51107/wp-content/uploads/2014/08/banner02.jpg" title=" Vacuum Cleaner -10%" alt=""/></figure><div class="extra-wrap"><h5> Vacuum Cleaner -10%</h5><p><span>Nunc pulvinar turpis</span></p><div class="link-align banner-btn">Shop now</div></div></a> </div>
    <div class="span4 "><a href="product/product-4/" title="Plasma Television -15%" class="banner-wrap "><figure class="featured-thumbnail"><img src="http://livedemo00.template-help.com/woocommerce_51107/wp-content/uploads/2014/08/banner03.jpg" title="Plasma Television -15%" alt=""/></figure><div class="extra-wrap"><h5>Plasma Television -15%</h5><p><span>Alli Nunc pulvinar turpis</span></p><div class="link-align banner-btn">Shop now</div></div></a> </div>
    </div> 
    </div></div>
    <div class="row ">
    <div class="span3 "><div class="featured_categories"><div class="featured_categories_wrap_inner">
    <h2>Categories</h2>
    <ul class='advanced_categories cols_1'>
    <li class='advanced_categories_item last'>
    <div class='advanced_categories_item_inner'>
    <h4><a href='http://livedemo00.template-help.com/woocommerce_51107/product-category/product-category-2/'>Donec vitae</a></h4>
    </div>
    </li>
    <li class='advanced_categories_item last'>
    <div class='advanced_categories_item_inner'>
    <h4><a href='http://livedemo00.template-help.com/woocommerce_51107/product-category/product-category-1/'>Lorem ipsum</a></h4>
    </div>
    </li>
    <li class='advanced_categories_item last'>
    <div class='advanced_categories_item_inner'>
    <h4><a href='http://livedemo00.template-help.com/woocommerce_51107/product-category/product-category-4/'>Nam felis nulla</a></h4>
    </div>
    </li>
    <li class='advanced_categories_item last'>
    <div class='advanced_categories_item_inner'>
    <h4><a href='http://livedemo00.template-help.com/woocommerce_51107/product-category/product-category-5/'>Proin ut</a></h4>
    </div>
    </li>
    <li class='advanced_categories_item last'>
    <div class='advanced_categories_item_inner'>
    <h4><a href='http://livedemo00.template-help.com/woocommerce_51107/product-category/product-category-3/'>Ut eget tortor</a></h4>
    </div>
    </li>
    </ul>
    </div></div></div>
    <div class="span9 "><div class="featured_products"><div class="featured_products_wrap_inner">
    ...
    <img width="300" height="300" src="http://livedemo00.template-help.com/woocommerce_51107/wp-content/uploads/2013/09/acer_h233h_bmid_23-inch_widescreen_lcd_display_black_1-300x300.jpg" class="attachment-shop_catalog wp-post-image" alt="acer_h233h_bmid_23-inch_widescreen_lcd_display_black_1"/>
    ...
    <a href="http://livedemo00.template-help.com/woocommerce_51107/product/product-12/">
    <img width="300" height="300" src="http://livedemo00.template-help.com/woocommerce_51107/wp-content/uploads/2013/09/behringer_headphones_hps3000_1-300x300.jpg" class="attachment-shop_catalog wp-post-image" alt="behringer_headphones_hps3000_1"/>
    ...
    <a href="http://livedemo00.template-help.com/woocommerce_51107/product/product-11/">
    <span class="onsale">Sale!</span>
    <img width="300" height="300" src="http://livedemo00.template-help.com/woocommerce_51107/wp-content/uploads/2013/09/b-e-w_803_diamond_floorstanding_loudspeakers_1-300x300.jpg" class="attachment-shop_catalog wp-post-image" alt="b-e-w_803_diamond_floorstanding_loudspeakers_1"/>
    ...
    <ul id="menu-footer-menu" class="menu"><li id="menu-item-2006" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-203 current_page_item menu-item-2006"><a href="http://livedemo00.template-help.com/woocommerce_51107/">Home</a></li>
