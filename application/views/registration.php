                                    ...
                                    <!--END SPINNER-->
                                            ...
                                            <table class="table smallfont">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td><img src="<?php echo SERVER2.$item['big_image'];?>" height="42" width="42">
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="right"><strong>Total</strong>
                                                        </td>
                                                        <td class="right">
                                        ...
                                        <form method="post" class="login" id="register-form" name="register-form" action="<?php echo site_url().'registro/crear_cliente';?>">
                                            ...
                                            <hr>
                                            <p class="form-row form-row-wide">
                                                <label for="username">Nombre<span class="required">*</span>
                                                </label>
                                                <input type="text" class="input-text" name="first_name" id="first_name" required="required" /> </p>
                                            <p class="form-row form-row-wide">
                                                <label for="password">Apellidos<span class="required">*</span>
                                                </label>
                                                <input name="last_name" id="last_name" class="input-text" required="required" /> </p>
                                            <p class="form-row form-row-wide">
                                                <label for="username">DNI<span class="required">*</span>
                                                </label>
                                                <input type="text" class="input-text" name="dni" id="dni" required="required" /> </p>
                                            <label for="fecha de nacimiento">Fecha de Nacimiento<span class="required">*</span>
                                            </label>
                                            <div class="false">
                                                <div class="controls">
                                            ...
                                            <hr>
                                            <p class="form-row form-row-wide">
                                                <label for="E-mail">E-mail<span class="required">*</span>
                                                </label>
                                                <input class="input-text" type="email" name="email" id="email" required="required" /> </p>
                                            <p class="form-row form-row-wide">
                                                <label for="Contraseña">Contraseña<span class="required">*</span>
                                                </label>
                                                <input class="input-text" type="password" class="input-text" name="password" id="password" required="required" /> </p>
                                            <p class="form-row">
