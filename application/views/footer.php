                                ...
                                <ul class="social social__row">
                                    <li class="social_li">
                                        <a class="social_link social_link__facebook" href="https://www.facebook.com/Wavelinetwork" target="_blank">
                                            <span class="social_ico">
                                                <img style="display:none;" src="<?php echo site_url().'static/images/icons/facebook.png?999';?>" alt="facebook"/>
                                            </span>
                                        </a>
                                    </li>
                                    ...
                                    <li class="social_li">
                                        <a class="social_link social_link__twitter" href="https://twitter.com/Wavelinetwork" target="_blank">
                                            <span class="social_ico">
                                                <img style="display:none;" src="<?php echo site_url().'static/images/icons/twitter.png?999';?>" alt="twitter"/>
                                            </span>
                                        </a>
                                    </li>
                                </ul>
